...
"}")
        ...
        sizePolicy3.setHeightForWidth(self.ik_mode_btn.sizePolicy().hasHeightForWidth())
        self.ik_mode_btn.setSizePolicy(sizePolicy3)

        self.gridLayout.addWidget(self.ik_mode_btn, 0, 3, 1, 1)
