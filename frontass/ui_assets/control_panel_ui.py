...
"}")
        ...
        self.pump_frame.setFrameShape(QFrame.StyledPanel)
        self.pump_frame.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.act_rpm_text.setFrameShape(QFrame.NoFrame)
        self.act_rpm_text.setFrameShadow(QFrame.Plain)
        self.act_rpm_text.setScaledContents(False)
        self.act_rpm_text.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.des_rpm_text.setFrameShape(QFrame.NoFrame)
        self.des_rpm_text.setFrameShadow(QFrame.Plain)
        self.des_rpm_text.setScaledContents(False)
        self.des_rpm_text.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.des_cur_text.setFrameShape(QFrame.NoFrame)
        self.des_cur_text.setFrameShadow(QFrame.Plain)
        self.des_cur_text.setScaledContents(False)
        self.des_cur_text.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.elmo_temp_text.setFrameShape(QFrame.NoFrame)
        self.elmo_temp_text.setFrameShadow(QFrame.Plain)
        self.elmo_temp_text.setScaledContents(False)
        self.elmo_temp_text.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.pump_config_btn.setLayoutDirection(Qt.LeftToRight)
...
"}")
        ...
        self.arm_power_frame.setFrameShape(QFrame.StyledPanel)
        self.arm_power_frame.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.ctrl_mode_cmb = QComboBox(self.arm_power_frame)
        self.ctrl_mode_cmb.setObjectName(u"ctrl_mode_cmb")
        self.ctrl_mode_cmb.setEnabled(True)
        self.ctrl_mode_cmb.setGeometry(QRect(340, 40, 161, 21))
        self.ctrl_mode_cmb.setFrame(True)
        self.label_20 = QLabel(self.arm_power_frame)
        self.label_20.setObjectName(u"label_20")
        self.label_20.setEnabled(True)
        self.label_20.setGeometry(QRect(340, 20, 111, 17))
        ...
        self.func_btn_frame.setFrameShape(QFrame.StyledPanel)
        self.func_btn_frame.setFrameShadow(QFrame.Raised)
        self.gridLayoutWidget = QWidget(self.func_btn_frame)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(10, 10, 401, 101))
        self.gridLayout = QGridLayout(self.gridLayoutWidget)
        self.gridLayout.setSpacing(20)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setContentsMargins(10, 10, 10, 10)
        self.arm_graph_tool_btn_2 = QPushButton(self.gridLayoutWidget)
        self.arm_graph_tool_btn_2.setObjectName(u"arm_graph_tool_btn_2")
        self.arm_graph_tool_btn_2.setEnabled(False)
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.MinimumExpanding)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.arm_graph_tool_btn_2.sizePolicy().hasHeightForWidth())
        self.arm_graph_tool_btn_2.setSizePolicy(sizePolicy2)

        self.gridLayout.addWidget(self.arm_graph_tool_btn_2, 0, 0, 1, 1)
        ...
        sizePolicy3.setHeightForWidth(self.start_pose_iteration_btn.sizePolicy().hasHeightForWidth())
        self.start_pose_iteration_btn.setSizePolicy(sizePolicy3)

        self.gridLayout.addWidget(self.start_pose_iteration_btn, 0, 2, 1, 1)

        self.arm_graph_tool_btn_4 = QPushButton(self.gridLayoutWidget)
        self.arm_graph_tool_btn_4.setObjectName(u"arm_graph_tool_btn_4")
        self.arm_graph_tool_btn_4.setEnabled(False)
        sizePolicy3.setHeightForWidth(self.arm_graph_tool_btn_4.sizePolicy().hasHeightForWidth())
        self.arm_graph_tool_btn_4.setSizePolicy(sizePolicy3)

        self.gridLayout.addWidget(self.arm_graph_tool_btn_4, 0, 1, 1, 1)

        self.start_pose_iteration_btn_2 = QPushButton(self.gridLayoutWidget)
        self.start_pose_iteration_btn_2.setObjectName(u"start_pose_iteration_btn_2")
        self.start_pose_iteration_btn_2.setEnabled(True)
        sizePolicy3.setHeightForWidth(self.start_pose_iteration_btn_2.sizePolicy().hasHeightForWidth())
        self.start_pose_iteration_btn_2.setSizePolicy(sizePolicy3)

        self.gridLayout.addWidget(self.start_pose_iteration_btn_2, 0, 3, 1, 1)

        self.tr_left_forward_bar = QProgressBar(self.centralwidget)
        self.tr_left_forward_bar.setObjectName(u"tr_left_forward_bar")
        self.tr_left_forward_bar.setGeometry(QRect(50, 420, 51, 75))
        self.tr_left_forward_bar.setValue(24)
        self.tr_left_forward_bar.setTextVisible(False)
        self.tr_left_forward_bar.setOrientation(Qt.Vertical)
        self.tr_right_forward_bar = QProgressBar(self.centralwidget)
        self.tr_right_forward_bar.setObjectName(u"tr_right_forward_bar")
        self.tr_right_forward_bar.setGeometry(QRect(110, 420, 51, 75))
        self.tr_right_forward_bar.setValue(24)
        self.tr_right_forward_bar.setTextVisible(False)
        self.tr_right_forward_bar.setOrientation(Qt.Vertical)
        ...
        self.tr_right_backward_bar.setGeometry(QRect(110, 490, 51, 75))
        self.tr_right_backward_bar.setValue(24)
        self.tr_right_backward_bar.setTextVisible(False)
        self.tr_right_backward_bar.setOrientation(Qt.Vertical)
        ...
        self.tr_left_backward_bar.setGeometry(QRect(50, 490, 51, 75))
        ...
        self.tr_left_backward_bar.setOrientation(Qt.Vertical)
        self.tr_left_backward_bar.setInvertedAppearance(True)
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(50, 380, 51, 40))
        self.label.setAlignment(Qt.AlignCenter)
        self.label_21 = QLabel(self.centralwidget)
        self.label_21.setObjectName(u"label_21")
        self.label_21.setGeometry(QRect(110, 380, 51, 40))
        ...
        self.tr_right_status_text.setGeometry(QRect(110, 570, 51, 20))
        self.tr_right_status_text.setAlignment(Qt.AlignCenter)
        self.tr_left_status_text = QLabel(self.centralwidget)
        self.tr_left_status_text.setObjectName(u"tr_left_status_text")
        self.tr_left_status_text.setGeometry(QRect(50, 570, 51, 20))
        self.tr_left_status_text.setAlignment(Qt.AlignCenter)
        self.label_24 = QLabel(self.centralwidget)
        self.label_24.setObjectName(u"label_24")
        self.label_24.setGeometry(QRect(10, 170, 81, 21))
        self.label_25 = QLabel(self.centralwidget)
        self.label_25.setObjectName(u"label_25")
        self.label_25.setGeometry(QRect(10, 200, 81, 21))
        self.client_ip_text = QLabel(self.centralwidget)
        self.client_ip_text.setObjectName(u"client_ip_text")
        self.client_ip_text.setGeometry(QRect(80, 170, 121, 21))
        self.robot_ip_text = QLabel(self.centralwidget)
        self.robot_ip_text.setObjectName(u"robot_ip_text")
        self.robot_ip_text.setGeometry(QRect(80, 200, 121, 21))
        self.label_28 = QLabel(self.centralwidget)
        self.label_28.setObjectName(u"label_28")
        self.label_28.setGeometry(QRect(10, 230, 81, 21))
        self.ping_text = QLabel(self.centralwidget)
        self.ping_text.setObjectName(u"ping_text")
        self.ping_text.setGeometry(QRect(80, 230, 51, 21))
        self.label_30 = QLabel(self.centralwidget)
        self.label_30.setObjectName(u"label_30")
        self.label_30.setGeometry(QRect(130, 230, 51, 21))
        ...
        self.arm_graph_layout.setSizeConstraint(QLayout.SetFixedSize)
        self.arm_graph_layout.setContentsMargins(0, 0, 0, 0)
        self.gridLayoutWidget_6 = QWidget(self.centralwidget)
        self.gridLayoutWidget_6.setObjectName(u"gridLayoutWidget_6")
        self.gridLayoutWidget_6.setGeometry(QRect(10, 270, 191, 91))
        ...
        self.read_rate_text = QLabel(self.gridLayoutWidget_6)
        self.read_rate_text.setObjectName(u"read_rate_text")

        self.gridLayout_6.addWidget(self.read_rate_text, 0, 1, 1, 1)

        self.cmd_rate_text = QLabel(self.gridLayoutWidget_6)
        self.cmd_rate_text.setObjectName(u"cmd_rate_text")

        self.gridLayout_6.addWidget(self.cmd_rate_text, 1, 1, 1, 1)

        self.pump_rate_text = QLabel(self.gridLayoutWidget_6)
        self.pump_rate_text.setObjectName(u"pump_rate_text")

        self.gridLayout_6.addWidget(self.pump_rate_text, 2, 1, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.arm_graph_tool_btn.sizePolicy().hasHeightForWidth())
        self.arm_graph_tool_btn.setSizePolicy(sizePolicy2)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1418, 27))
...
"OFF", None))
        ...
        self.ctrl_mode_cmb.setCurrentText("")
        self.label_20.setText(QCoreApplication.translate("MainWindow", u"Control Mode", None))
        ...
        self.arm_graph_tool_btn_2.setText(QCoreApplication.translate("MainWindow", u"Master\n"
"set zero", None))
        self.start_pose_iteration_btn.setText(QCoreApplication.translate("MainWindow", u"Start\n"
"Pose\n"
"Iteration", None))
        self.arm_graph_tool_btn_4.setText(QCoreApplication.translate("MainWindow", u"Slave\n"
"set zero", None))
        self.start_pose_iteration_btn_2.setText(QCoreApplication.translate("MainWindow", u"IK\n"
"Mode", None))
...
"Right", None))
        ...
        self.label_24.setText(QCoreApplication.translate("MainWindow", u"Client IP:", None))
        self.label_25.setText(QCoreApplication.translate("MainWindow", u"Robot IP:", None))
        self.client_ip_text.setText(QCoreApplication.translate("MainWindow", u"123.456.789.012", None))
        self.robot_ip_text.setText(QCoreApplication.translate("MainWindow", u"888.888.888.888", None))
        self.label_28.setText(QCoreApplication.translate("MainWindow", u"Ping:", None))
        self.ping_text.setText(QCoreApplication.translate("MainWindow", u"[PING]", None))
        self.label_30.setText(QCoreApplication.translate("MainWindow", u"ms", None))
